...
- **The prototype mirrors the frontend.** `prototype/napm-prototype.html` is kept byte-identical to `frontend/index.html`. After any change to the frontend, run `cp frontend/index.html prototype/napm-prototype.html`.
